...
import java.util.Collections; //Addeding in for 1.7.10-fbmp
...
public class HTMLParser {
    ...
    public static boolean sendToAll(FoxBukkitChat plugin, String format) {
        return sendToPlayers(plugin, Arrays.asList(plugin.getServer().getOnlinePlayers()), format); //Added Arrays.asList() for 1.7.10-fbmp to  update
    }
