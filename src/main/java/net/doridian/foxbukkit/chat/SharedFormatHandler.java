...
import net.doridian.foxbukkit.chat.json.ChatMessageIn;
import net.doridian.foxbukkit.chat.json.ChatMessageOut;
import net.doridian.foxbukkit.chat.json.TargetType;
import net.doridian.foxbukkit.chat.json.UserInfo;
